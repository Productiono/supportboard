...
function sb_process_api() {
    ...
    $apps = [
        'SB_WP' => ['wp-sync'],
        'SB_DIALOGFLOW' => ['dialogflow-message', 'dialogflow-create-intent', 'dialogflow-intent', 'dialogflow-entity', 'dialogflow-get-entity', 'google-get-token', 'dialogflow-get-agent', 'dialogflow-set-active-context', 'dialogflow-curl'],
