...
function sb_ajax_execute() {
    ...
    switch ($function) {
        ...
        case 'send-custom-email':
            return sb_json_response(sb_email_send($_POST['to'], $_POST['subject'], sb_email_default_parts(sb_merge_fields(sb_google_translate_auto($_POST['message'], sb_post('recipient_id'))), sb_post('recipient_id'))));
        ...
        case 'send-sms':
            return sb_json_response(sb_send_sms(sb_google_translate_auto($_POST['message'], sb_post('recipient_id')), $_POST['to'], sb_post('template', true), sb_post('conversation_id'), sb_post('attachments')));
        case 'direct-message':
